...
#CNAME records voor servers
Add-DnsServerResourceRecordCName -Name "ns1" -HostNameAlias "zeus.$domein" -ZoneName $domein
Add-DnsServerResourceRecordCName -Name "ns2" -HostNameAlias "apollo.$domein" -ZoneName $domein
Add-DnsServerResourceRecordCName -Name "mail" -HostNameAlias "hermes.$domein" -ZoneName $domein

#Mail
Add-DnsServerResourceRecordMX -Preference 10  -Name "@" -MailExchange "mail.$domein" -ZoneName "contoso.com"